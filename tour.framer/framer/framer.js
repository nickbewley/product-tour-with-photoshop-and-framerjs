...
AnimationLoop = {
  ...
  _tick: function(timestamp) {
    var animator, delta, fps, index, _i, _len, _ref;
    if (!AnimationLoop._animators.length) {
...
},{"./AnimationLoop":2,"./Config":11,"./EventEmitter":16,"./Utils":32}],4:[function(require,module,exports){
...
var Animation, BaseClass, Config, Defaults, EventEmitter, Frame, LayerDraggable, LayerStates, LayerStyle, Utils, layerProperty, layerStyleProperty, _,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
...
layerProperty = function(obj, name, cssProperty, fallback, validator, set) {
  var result;
  obj.prototype["set_" + name] = function(value) {
  ...
  return result = {
    ...
    set: function(value) {
      ...
      return typeof set === "function" ? set(this, value) : void 0;
    }
  };
};

layerStyleProperty = function(obj, cssProperty) {
  var result;
  obj.prototype["set_" + cssProperty] = function(value) {
    return this.style[cssProperty] = value;
  };
  return result = {
    exportable: true,
    get: function() {
...
exports.Layer = (function(_super) {
  ...
  Layer.define("backgroundColor", layerStyleProperty(Layer, "backgroundColor"));

  Layer.define("color", layerStyleProperty(Layer, "color"));

  Layer.define("borderRadius", layerStyleProperty(Layer, "borderRadius"));

  Layer.define("borderColor", layerStyleProperty(Layer, "borderColor"));

  Layer.define("borderWidth", layerStyleProperty(Layer, "borderWidth"));
